...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="mb-6">
        ...
        <form method="POST" action="{{ route('admin.movies.store') }}" class="mb-6">
            @csrf
            <input type="hidden" name="import_from_tmdb" value="1">
            <div class="mb-4">
    ...
    <div>
        ...
        <form method="POST" action="{{ route('admin.movies.store') }}">
            @csrf
            {{-- No tmdb_id here to distinguish manual entry --}}
            <input type="hidden" name="import_from_tmdb" value="0">
